...
Price: $%.2f" % (
        ...
        logger.info("Trade notification: %s", message)
...
%s" % (alert_type, message)
    ...
    def send_system_notification(self, user_id: int, message: str) -> bool:
        ...
        logger.info("System notification: %s", message)
    ...
    def _send_telegram(self, message: str) -> bool:
        ...
        try:
            ...
            url = "https://api.telegram.org/bot%s/sendMessage" % self._telegram_bot_token
            payload = {
    ...
    def configure_telegram(self, bot_token: str, chat_id: str) -> None:
        ...
        logger.info("Telegram notifications: %s", self._telegram_enabled)
